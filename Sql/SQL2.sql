...
CREATE INDEX index_info ON customers(name, city);
-- TO SEE INDEX
SHOW INDEX
FROM customers;
-- TO DROP INDEX
...
DELIMITER $$ CREATE PROCEDURE get_balance(IN acc_id INT, OUT bal DECIMAL(10, 2)) BEGIN
SELECT amount INTO bal
FROM orders
